...
public class ExcelWriteMapUtils {
	 ...
	 * @param filePath 文件路径
	 * @param title 标题
	 * @param headersName 首行数据名称
	 * @param headersId 数据的实体标识
	 * @param dtoList map数据
	 */
    public void exportExcel(String filePath,String title, List<String> headersName, List<String> headersId,
    ...
    public static void main(String [] args) {
        ...
        exportExcelUtil.exportExcel("D://file//Map33.xls","测试POI导出EXCEL文档2",listName,listId,listB);
